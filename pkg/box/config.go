...
type PluginConfig struct {
	BoxClientId       string `json:"boxclientid" jsonschema:"title=Box Custom App Client Id,required"`
	BoxClientSecret   string `json:"boxclientsecret" jsonschema:"title=Box Custom App Client Secret,required"`
	BoxEnterpriseID   int64  `json:"boxenterpriseid" jsonschema:"title=Box Enterprise ID,required"`
